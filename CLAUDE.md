...
Типичный модуль состоит из двух файлов:

1. **ИмяМодуляClass.js** - класс с бизнес-логикой (например, `FishingClass.js`, `Mining.js`)
2. **process-имя-модуля.js** - точка входа content script, инициализация и запуск (например, `fishing.js`, `process-mining.js`)
