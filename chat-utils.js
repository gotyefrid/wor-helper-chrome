...
function getLastPrivateMessage() {
    ...
    let playerName = localStorage.getItem('wor_player_name');

    if (playerName) {
        // Находим первое сообщение, адресованное юзеру и не являющееся системой
        let foundMessage = messages.find(msg => msg.to === playerName && msg.type !== "система");
